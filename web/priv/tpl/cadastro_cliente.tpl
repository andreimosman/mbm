    ...
    <table border=0 width="600">
      ...
      <tr>
        ...
        <td colspan="3" align="left"><input type="radio" name='status' value='A' class="checkbox2" {$status_ck1}>
          <font face="arial" size="-1" color="#009900">Ativo</font> <input type="radio" name='status' value='B' class="checkbox2" {$status_ck2}>
      ...
      <tr>
        ...
        <td align="left"><input type="text" name="logradouro" value="{$logradouro}" maxlength="25">
          nº <input type="text" name="numero" value="{$numero}" maxlength="8" size=4></td>
...
N&atilde;o</font></td>
          ...
          <tr>
            <td align="right"><font face="arial" size="-1"><b>ISP ou Gateway:</b></font></td>
            <td><font face="arial" size="-1">
...
N&atilde;o</font></td>
          ...
          <tr>
            <td align="right"><font face="arial" size="-1"><b>Conex&atilde;o via:</b></font></td>
            <td><font face="arial" size="-1">
