  ...
  <div align="center">
    ...
    <table border=0 width="500">
      ...
      <tr> 
        ...
        <td align="left"><input type="text" name="senha" value="{senha}" maxlength="15"></td>
      </tr>
      <tr> 
        <td width="140"><font face="arial" size="-1"><b>Host PPPoE:</b></font></td>
        <td align="left">{pppoe_select}</td>
      </tr>
      <tr> 
      ...
      <tr> 
        ...
        <td align="left"><input type="radio" name='status' value='A' {status_ck1}>
          <font face="arial" size="-1" color="#009900">Ativo</font> <input type="radio" name='status' value='B' {status_ck2}>
      ...
      <tr> 
        ...
        <td align="left"><font face="arial" size="-1">
          <input type="radio" name='tp_pessoa' value='F' {tp_pessoa_ck1}>
          Física 
          <input type="radio" name='tp_pessoa' value='J' {tp_pessoa_ck2}>
          Jurídica</font></td>
      </tr>
      <tr> 
      ...
      <tr> 
        ...
        <td align="left"><input type="text" name="logradouro" value="{logradouro}" maxlength="25">
          ...
          - 
          <input type="text" name="complemento" value="{complemento}" maxlength="20" size=10></td>
      </tr>
      <tr> 
      ...
      <tr> 
        ...
        <td align="left"><input type="text" name="dt_ativacao" value="{dt_ativacao}" maxlength="10"> 
      ...
      <tr> 
        ...
        <td align="left"><font face="arial" size="-1">
          <input type="radio" name='flg_comodato' value='t' {flg_comodato_ck1}>
          Sim 
          <input type="radio" name='flg_comodato' value='f' {flg_comodato_ck2}>
          Não</font></td>
      </tr>
      <tr> 
        <td><font face="arial" size="-1"><b>ISP ou Gateway:</b></font></td>
        <td align="left"><font face="arial" size="-1">
          <input type="radio" name='flg_gw_isp' value='t' {flg_gw_isp_ck1}>
          Sim 
          <input type="radio" name='flg_gw_isp' value='f' {flg_gw_isp_ck2}>
          Não</font></td>
      </tr>
      <tr> 
        <td><font face="arial" size="-1"><b>Conexão via:</b></font></td>
        <td align="left"><font face="arial" size="-1">
          <input type="radio" name='tipo_conexao' value='R' {tipo_conexao_ck1}>
          Rádio 
          <input type="radio" name='tipo_conexao' value='C' {tipo_conexao_ck2}>
          Cabo</font></td>
      </tr>
      <tr> 
        <td valign="top"><font face="arial" size="-1"><b>Observações:</b></font></td>
        <td align="left"><font face="arial" size="-1">
          <textarea name="observacoes" cols=35 rows=10>{observacoes}</textarea></td>
      </tr>
