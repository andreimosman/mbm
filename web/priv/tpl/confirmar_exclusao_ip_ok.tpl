...
<div align="center">Exclusão do IP</div>
</b></font>
<hr size=1 width="500" color="#000000" align="center">
<table align="center" width=500><tr><td>
<font face="arial" size="2"><b>Exclusão realizada com sucesso
  !!!</b></font><br>
  <br>
  <font size="2" face="arial"> IP eliminado: <i>{$ip}</i> <br>
  <br>
   A exclusão eliminou automaticamente o seguinte cliente: </font>
  <ol>
...
<font size="2" face="arial"><br>
  <br>
  <a href="{$smarty.server.PHP_SELF}?sessao=listaIPs">voltar</a> </font>
